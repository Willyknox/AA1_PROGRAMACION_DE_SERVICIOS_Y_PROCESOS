...
public class Transaction {
    ...
    // class attributes are declared outside constructor/methods so they belong to
    // the object
    private String from;
    private String to;
    private int amount;

    // constructors don't have return types (not even void or String) and take
    // initial parameters
    ...
    public static Transaction generateRandom() {
        ...
        String[] namesArray = { "Federico", "Fernando", "Maria", "José", "Luis", "Pedro", "Juan", "Ana", "Elena",
                "Carlos" };
